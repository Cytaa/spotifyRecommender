...
client_id = "7d6ce345594046a3bc15b51dde84bcd7"
client_secret = "66aa8c53d26246428cae5826ab11a8e6"
...
def generate_playlist_df(playlist_name, playlist_dic, spotify_data):
    ...
    return playlist
playlist_df = generate_playlist_df('Supeł', playlist_dic, spotify_data)
playlist_df.head(); 
